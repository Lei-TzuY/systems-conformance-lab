...
class HTTPContentEncodingTarget:
    """Python urllib loopback HTTP response-observation target."""
    ...
    def as_command_target(self) -> CommandTarget:
        ...
        return CommandTarget(
            (
                sys.executable,
                "-m",
                "systems_conformance._http_content_encoding_worker",
                "--max-wire-body-bytes",
                str(self.max_wire_body_bytes),
