...
- bounded repro loading that validates schema, exact v1 manifest fields, direct-child layout, artifact sizes, input digests when present, and stable failure identity before replay
